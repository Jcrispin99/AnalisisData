"""
Django settings for analisis_data project.
...
SECRET_KEY = 'django-insecure-hpchs#x9^q)5-dwe3z)azwndky(-c%q9)h84b+pcohp@k=y_=l'
...
ROOT_URLCONF = 'analisis_data.urls'
...
WSGI_APPLICATION = 'analisis_data.wsgi.application'
